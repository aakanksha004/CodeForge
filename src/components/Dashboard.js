...
const Dashboard = () => {
  ...
  className="relative group overflow-hidden text-white p-3 rounded-3xl flex items-center gap-2 bg-gradient-to-r from-purple-400 via-indigo-500 to-indigo-600"
>
  <div className="absolute inset-0 w-0 bg-gradient-to-r from-indigo-900 via-purple-600 to-indigo-700 transition-all duration-500 ease-out group-hover:w-full" />
  <span className="flex items-center gap-2 relative z-10">
    <FaTags />
    Filter by Tags
        ...
        className={`relative group overflow-hidden text-white p-3 rounded-3xl flex items-center gap-2 ${
          showStarred ? 'bg-gradient-to-r from-purple-400 via-indigo-500 to-indigo-600' : 'bg-gradient-to-r from-purple-400 via-indigo-500 to-indigo-600'
        }`}
      >
        <div className="absolute inset-0 w-0 bg-gradient-to-r from-indigo-900 via-purple-600 to-indigo-700 transition-all duration-500 ease-out group-hover:w-full" />
        <span className="flex items-center gap-2 relative z-10">
